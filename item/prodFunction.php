...
function itemParse($upc){
	...
	echo "<td>&nbsp;</td><td>&ndsp;</td><td>Inventory Amount</td><td>$<input type='text' value='$rowItem[33]' name='inventory' size='10'/></td><td>Low Limit</td><td>$<input type='text' value='$rowItem[34]' name='lowlimit' size='10'/></td></tr>";
